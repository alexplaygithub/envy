...
new WinBox({
  title: "Envy Version 7.3 M.4 Preview",
  class: ["no-min", "no-max", "no-close","no-title","eclipsemono"],
  x: "center",
  y: "center",
  width: "50%",
  height: "75%",
...
function dark() {
  localStorage.setItem("bg", "./assets/wp.png");
  document.body.style.backgroundImage = 'url("' + "assets/wp.png" + '")';
...
function light() {
  ...
  document.body.style.backgroundImage = 'url("' + "assets/wp2.png" + '")';
